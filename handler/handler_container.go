...
var handlerMapping = map[avro.Action]ActionHandler{
	...
	avro.ActionRequest_customer_update_state:             &CustomerUpdateStateHanlder{},
	avro.ActionRequest_customer_start_game:               &CustomerStartGameHanlder{},
	avro.ActionRequest_customer_upload_game_score:        &CustomerUploadGameScoreHanlder{},
